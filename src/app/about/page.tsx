    ...
    <div className="pt-24 pb-16 bg-black min-h-screen">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold mb-6 text-white uppercase">About Lembra</h1>
        ...
        {/* CEO Message Section */}
        <div className="bg-black rounded-2xl shadow-lg p-8 mb-16">
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="flex-1 text-center">
              <h2 className="text-2xl font-bold mb-4 uppercase">A Message from Our Founder</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <div>
            <h2 className="text-3xl font-bold mb-6 text-white uppercase">Our Mission</h2>
          ...
          <div>
            <h2 className="text-3xl font-bold mb-6 text-white uppercase">Our Values</h2>
            <ul className="space-y-4">
              <li className="flex items-start">
                <div className="w-2 h-2 bg-blue-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                <span className="text-gray-300"><strong>Respect:</strong> Every life has value and every story matters</span>
              </li>
              <li className="flex items-start">
                <div className="w-2 h-2 bg-blue-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                <span className="text-gray-300"><strong>Accessibility:</strong> Beautiful memorials should be available to everyone</span>
              </li>
              <li className="flex items-start">
                <div className="w-2 h-2 bg-blue-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                <span className="text-gray-300"><strong>Privacy:</strong> Your memories are sacred and protected</span>
              </li>
              <li className="flex items-start">
                <div className="w-2 h-2 bg-blue-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                <span className="text-gray-300"><strong>Simplicity:</strong> Creating a memorial should be easy and intuitive</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-gray-50 rounded-2xl p-8 mb-16">
          <h2 className="text-3xl font-bold text-center mb-12 uppercase">What Makes Lembra Special</h2>
        ...
        <div className="text-center bg-blue-50 rounded-2xl p-12">
          <h2 className="text-3xl font-bold mb-4 uppercase">Ready to Honor Your Loved One?</h2>
